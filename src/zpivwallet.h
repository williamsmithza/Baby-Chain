...
#ifndef BABY_ZBABYWALLET_H
#define BABY_ZBABYWALLET_H
...
public:
    CzBABYWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBABY(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBABY(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //BABY_ZBABYWALLET_H
