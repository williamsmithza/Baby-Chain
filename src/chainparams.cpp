...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "baby.seed.fuzzbawls.pw"));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "baby.seed2.fuzzbawls.pw"));    // Secondary DNS Seeder from Fuzzbawls
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zbaby to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "baby-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "baby-testnet.seed2.fuzzbawls.pw"));
