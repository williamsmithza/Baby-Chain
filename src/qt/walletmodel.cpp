...
static void NotifyzBABYReset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzBABYReset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzBABYReset.connect(boost::bind(NotifyzBABYReset, this));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzBABYReset.disconnect(boost::bind(NotifyzBABYReset, this));
...
{
    setMints.clear();
    setMints = pwalletMain->zbabyTracker->ListMints(fUnusedOnly, fMaturedOnly, fUpdateStatus);
}
