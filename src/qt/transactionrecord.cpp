...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zbabyTracker->HasMintTx(hash))) {
            //zBABY stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZBABY;
...
bool IsZBABYType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZBABY:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZBABY || type == TransactionRecord::MNReward) {
