...
#include "ui_zbabycontroldialog.h"
...
std::set<std::string> ZBabyControlDialog::setSelectedMints;
std::set<CMintMeta> ZBabyControlDialog::setMints;

bool CZBabyControlWidgetItem::operator<(const QTreeWidgetItem &other) const {
    int column = treeWidget()->sortColumn();
    if (column == ZBabyControlDialog::COLUMN_DENOMINATION || column == ZBabyControlDialog::COLUMN_VERSION || column == ZBabyControlDialog::COLUMN_CONFIRMATIONS)
...
void ZBabyControlDialog::updateList()
{
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        CZBabyControlWidgetItem* itemDenom(new CZBabyControlWidgetItem);
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        CZBabyControlWidgetItem *itemMint = new CZBabyControlWidgetItem(ui->treeWidget->topLevelItem(mapDenomPosition.at(denom)));
...
void ZBabyControlDialog::updateLabels()
{
    ...
    privacyDialog->setZBabyControlLabels(nAmount, setSelectedMints.size());
}

std::vector<CMintMeta> ZBabyControlDialog::GetSelectedMints()
{
