                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBABYPathCustom = GetArg("-zbabybackuppath", "");
    ...
    if(!strzBABYPathCustom.empty()) {
        ui->wallet_customzbabybackuppath->setText(QString::fromStdString(strzBABYPathCustom));
        ui->wallet_customzbabybackuppath_label->setVisible(true);
        ui->wallet_customzbabybackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBABYPathCustom.empty()) && nCustomBackupThreshold > 0) {
