...
extern UniValue setzbabyseed(const UniValue& params, bool fHelp);
extern UniValue getzbabyseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbaby(const UniValue& params, bool fHelp);
extern UniValue dzbabystate(const UniValue& params, bool fHelp);
