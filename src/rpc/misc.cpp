...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    ...
    UniValue zbabyObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zbabyObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zbabyObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.push_back(Pair("zBABYsupply", zbabyObj));
