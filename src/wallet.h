...
enum ZerocoinSpendStatus {
    ...
    ZBABY_SPEND_V1_SEC_LEVEL                         // Spend is V1 and security level is not set to 100
};
...
public:
    ...
    bool CreateZBABYOutPut(libzerocoin::CoinDenomination denomination, CTxOut& outMint, CDeterministicMint& dMint);
    bool GetMint(const uint256& hashSerial, CZerocoinMint& mint);
    bool GetMintFromStakeHash(const uint256& hashStake, CZerocoinMint& mint);
    bool DatabaseMint(CDeterministicMint& dMint);
    bool SetMintUnspent(const CBigNum& bnSerial);
    bool UpdateMint(const CBigNum& bnValue, const int& nHeight, const uint256& txid, const libzerocoin::CoinDenomination& denom);
    string GetUniqueWalletBackupName(bool fzbabyAuto) const;
    ...
    */
    ...
    CzBABYWallet* zwalletMain;

    bool fFileBacked;
    bool fWalletUnlockAnonymizeOnly;
    std::string strWalletFile;
    bool fBackupMints;
    std::unique_ptr<CzBABYTracker> zbabyTracker;
    ...
    void setZWallet(CzBABYWallet* zwallet)
    {
        zwalletMain = zwallet;
        zbabyTracker = std::unique_ptr<CzBABYTracker>(new CzBABYTracker(strWalletFile));
    }

    CzBABYWallet* getZWallet() { return zwalletMain; }
    ...
    /** zBABY reset */
    boost::signals2::signal<void()> NotifyzBABYReset;
