...
#   c) node1 mines 32 blocks, so now node 0 has 60001baby, node 1 has 4250baby, node2 has none.
#   d) node0 sends 601 baby to node2, in two transactions (301 baby, then 300 baby).
